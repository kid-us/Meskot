...
import "../../accounts.css";
import { signUp, logo } from "../../assets";
...
const SignUpTravellers = () => {
  ...
  return (
    <>
      <div className="traveller-page px-1">
          ...
          <div className="row justify-content-center shadow-lg rounded bg-white mx-lg-5 px-1">
            ...
            <div className="col-lg-6 col-6 col-12 px-lg-5 py-4">
              ...
              <p className="fs-5 px-lg-4">
                Create your Meskot Traveller account now!
              </p>
              <form
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="Email"
                  className={`form-control border rounded border-warning  mb-2 fs-6 fw-semibold py-2 ${
                ...
                <div className="mb-3 border border-warning rounded">
                  <PhoneInput
                    defaultCountry="et"
                    value={phone}
...
export default SignUpTravellers;
